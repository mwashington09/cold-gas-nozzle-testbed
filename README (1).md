...
The aerospike spike contour was generated using a Python implementation of **Angelino's approximate method** for axisymmetric plug nozzles. Using the heat capacity ratio of CO₂ (γ = 1.29) and the expansion ratio of ε = 4, produces:
